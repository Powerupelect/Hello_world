...
import modal_novo_processo, modal_novo_advogado, modal_advogados
from app import app
...
layout = dbc.Container([
        ...
        dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.H1("Ester/Lucas", style={'color': 'white'})
                ])
            ]),
            dbc.Row([
                dbc.Col([
...
], style={'height': '100vh', 'padding'  :'0px', 'position':'sticky', 'top': 0, 'background-color': "#003B46"})
